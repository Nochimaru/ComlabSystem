                ...
                <tbody>
                    <?php
                        ...
                        if($result){
                            ...
                            <td>' . $UserID . '</td>
                            <td>
                                <button class="btn btn-primary"><a href="EditItem.php?updateSerial=' . $SerialNum . '" class="text-light">Edit</a></button>
                                <button class="btn btn-danger"><a href="DeleteItem.php?deleteSerial=' . $SerialNum . '" class="text-light">Remove</a></button>
                            </td>
                        </tr>';
