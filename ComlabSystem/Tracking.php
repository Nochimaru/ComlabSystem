...
<div class="parent">
        <div class="childleft">
            <a href="itemTracking.php"><img src="DeviceList.png" class="logo-img"></a>

        </div>
    </div>
    <div class="parent1">
        <div class="childleft">
            <a href="Borrow.php"><img src="BorrowDevice.png" class="logo-img"></a>

        </div>
        <div class="childright">
            <a href="Return.php"><img src="ReturnDevice.png" class="logo-img"></a>

        </div>
    </div>

    <div class="header">
        <div class="side-nav">z
